...
_STAGE_VALUES = {
  "export", "fxtypedfx", "rewrite", "bulk",
  "loopy", "tron", "cpp", "success", "unknown",
}
...
def migrate_report(data: dict) -> bool:
  ...
  if raw_verdict in _VERDICT_VALUES:
    ...
    assessment["verdict"] = _classify_prose_verdict(
      raw_verdict
    )
